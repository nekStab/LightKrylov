program demo
   ...
   call newton(sys, bf, gmres_rdp, info, rtol=tol, atol=tol, options=opts, scheduler=constant_tol_dp)
   ...
   call newton(sys, bf, gmres_rdp, info, rtol=tol, atol=tol, options=opts, scheduler=dynamic_tol_dp)
